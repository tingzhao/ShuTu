...
MANAGER Tiff(Tio) reader*Tiff_Reader writer*Tiff_Writer ifd*Tiff_IFD img*Tiff_Image
...
{ int i;
  ...
  Array *img = Read_Image("/Users/zhaot/Work/neutube/neurolabi/data/biocytin/JL_07_19_14_2_100x_z004m01_ORG.tif.tiff", 0);
  Print_Array(img, stdout, 0, "%d");
