...
/*!
 * \brief Flip a stack along Y
 *
 * It does in-place flip if \a out is the same as \a stack. It returns a new
 * \a stack object if \a out is NULL;
 */
Mc_Stack* flipY(Mc_Stack *stack, Mc_Stack *out);
