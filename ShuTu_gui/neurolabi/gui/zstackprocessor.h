...
public:
  ...
  static Stack* PartialDiff(Stack *stack, double sx, double sy, double sz,
                            NeuTube::EAxis axis);
  static Stack* PartialDiff(Stack *stack, double sx, double sy, double sz,
                            NeuTube::EAxis axis1, NeuTube::EAxis axis2);

  static void ShrinkSkeleton(Stack *stack, int level);

  static Stack* EnhanceLine(Stack *stack, double sigmaX, double sigmaY, double sigmaZ);
